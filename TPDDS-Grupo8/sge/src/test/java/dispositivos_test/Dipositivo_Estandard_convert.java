...
public class Dipositivo_Estandard_convert {
    ...
    public void setup() throws IOException{
    	...
    	dispositivo.setConsumoKWHora(150);
    	dispositivo.setNombre_generico("nombre");
    	clientes.get(2).ConvertirADispositivoInteligente(dispositivo, adaptador);
